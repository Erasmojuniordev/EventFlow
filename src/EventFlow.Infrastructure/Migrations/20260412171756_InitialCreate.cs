        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    status = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
                    ticket_code = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    created_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    updated_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateIndex(
                name: "ix_tickets_event_attendee",
                table: "tickets",
                columns: new[] { "event_id", "attendee_id" });

            migrationBuilder.CreateIndex(
                name: "ix_waitlist_event_attendee_unique",
                table: "waitlist_entries",
                columns: new[] { "event_id", "attendee_id" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "ix_waitlist_event_position",
                table: "waitlist_entries",
                columns: new[] { "event_id", "position", "is_promoted" });
        }
